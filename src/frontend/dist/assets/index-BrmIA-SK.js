const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/ShopPage-frHq3r4C.js","assets/Layout-DGc-UyHY.js","assets/ProductCard-DyjFD5f-.js","assets/card-CZWIEjsJ.js","assets/useBackend-C4FxJ3vZ.js","assets/proxy-CoeVpKA6.js","assets/sparkles-_xxA7JUv.js","assets/ProductDetailPage-DHqDWbbJ.js","assets/label-CiDjjNje.js","assets/separator-DdAPHIV_.js","assets/arrow-left-DK4PSKg8.js","assets/circle-check-big-BCRpcjay.js","assets/CartPage-BAW2svJw.js","assets/arrow-right-BqC0X93_.js","assets/CheckoutPage-BksNE-xA.js","assets/GuidesPage-DD7OBGAX.js","assets/clock-BgurLkQK.js","assets/GuideArticlePage-DZ6h54hQ.js","assets/SubscriptionPage-C52CXFas.js"])))=>i.map(i=>d[i]);
...
function CartProvider({ children }) {
  ...
  const addItem = reactExports.useCallback((product) => {
    setItems((prev) => {
...
const ShopPage = reactExports.lazy(
  () => __vitePreload(() => import("./ShopPage-frHq3r4C.js"), true ? __vite__mapDeps([0,1,2,3,4,5,6]) : void 0).then((m) => ({ default: m.ShopPage }))
);
const ProductDetailPage = reactExports.lazy(
  () => __vitePreload(() => import("./ProductDetailPage-DHqDWbbJ.js"), true ? __vite__mapDeps([7,1,8,9,2,3,4,10,5,11]) : void 0).then((m) => ({
    default: m.ProductDetailPage
  }))
);
const CartPage = reactExports.lazy(
  () => __vitePreload(() => import("./CartPage-BAW2svJw.js"), true ? __vite__mapDeps([12,1,9,5,13]) : void 0).then((m) => ({ default: m.CartPage }))
);
const CheckoutPage = reactExports.lazy(
  () => __vitePreload(() => import("./CheckoutPage-BksNE-xA.js"), true ? __vite__mapDeps([14,1,8,9,11]) : void 0).then((m) => ({ default: m.CheckoutPage }))
);
const GuidesPage = reactExports.lazy(
  () => __vitePreload(() => import("./GuidesPage-DD7OBGAX.js"), true ? __vite__mapDeps([15,1,4,5,6,16,13]) : void 0).then((m) => ({ default: m.GuidesPage }))
);
const GuideArticlePage = reactExports.lazy(
  () => __vitePreload(() => import("./GuideArticlePage-DZ6h54hQ.js"), true ? __vite__mapDeps([17,1,9,2,3,4,10,5,16]) : void 0).then((m) => ({
    default: m.GuideArticlePage
  }))
);
const SubscriptionPage = reactExports.lazy(
  () => __vitePreload(() => import("./SubscriptionPage-C52CXFas.js"), true ? __vite__mapDeps([18,1,3,9,11,6]) : void 0).then((m) => ({
    default: m.SubscriptionPage
  }))
);
function PageFallback() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-12 space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-10 w-64" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-3/4" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-8", children: [1, 2, 3, 4, 5, 6].map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-72 rounded-lg" }, n)) })
  ] });
}
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(CartProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) })
});
const shopRoute = createRoute({
  ...
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShopPage, {}) })
});
const productDetailRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/products/$id",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductDetailPage, {}) })
});
const cartRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/cart",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CartPage, {}) })
});
const checkoutRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/checkout",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckoutPage, {}) })
});
const guidesRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/guides",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(GuidesPage, {}) })
});
const guideArticleRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/guides/$id",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(GuideArticlePage, {}) })
});
const subscribeRoute = createRoute({
  getParentRoute: () => rootRoute,
  path: "/subscribe",
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(PageFallback, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(SubscriptionPage, {}) })
});
